...
class CEA_Net(nn.Module):
    def __init__(self, num_classes=1, num_channels=1):
        ...
        self.firstconv = nn.Conv2d(num_channels, filters[0], kernel_size=7, stride=2, padding=3, bias=False)
#        self.firstconv = resnet.conv1
        ...
        self.att = Attention_block(F_g=f,F_l=f,F_int=256)

        self.decoder4 = DecoderBlock(f, filters[2])
...
class CEA_Net_backbone_DAC_without_atrous(nn.Module):
    def __init__(self, num_classes=1, num_channels=3):
        super(CEA_Net_backbone_DAC_without_atrous, self).__init__()
...
class CEA_Net_backbone_DAC_with_inception(nn.Module):
    def __init__(self, num_classes=1, num_channels=3):
        super(CEA_Net_backbone_DAC_with_inception, self).__init__()
...
class CEA_Net_backbone_inception_blocks(nn.Module):
    def __init__(self, num_classes=1, num_channels=3):
        super(CEA_Net_backbone_inception_blocks, self).__init__()
...
class CEA_Net_OCT(nn.Module):
    def __init__(self, num_classes=1, num_channels=3):
        super(CEA_Net_OCT, self).__init__()
